        ...
        <>
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr] p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <p className='text-black dark:text-white mt-1'>Demo: <a href="https://www.youtube.com/watch?v=h5wzYKiDfWU" target='_blank' className='text-red-500 font-semibold'>Youtube</a> | <a href="https://multi-sig-wallet-tule.vercel.app/" target="_blank" className='text-green-500 font-semibold'>Live demo</a> <span className='text-[12px] italic text-yellow-600 dark:text-yellow-300'>(Require metamask wallet and ETH goerli testnet)</span></p>
                </div>
            </div>
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                <div className='relative flex items-center justify-center'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <p className='text-black dark:text-white mt-1'>Demo: <a href="https://youtu.be/NI7Djuy6Ii8" target='_blank' className='text-red-500 font-semibold'>Youtube</a> | <a href="https://nft-marketplace-tule.vercel.app/" target="_blank" className='text-green-500 font-semibold'>Live demo</a> <span className='text-[12px] italic text-yellow-600 dark:text-yellow-300'>(Require metamask wallet and ETH goerli testnet)</span></p>
                </div>
            </div>
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                <div className='relative flex items-center justify-center'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <p className='text-black dark:text-white mt-1'>Demo: <a href="https://youtu.be/BvUq3oLQxXA" target='_blank' className='text-red-500 font-semibold'>Youtube</a> | <span className='text-[12px] italic'>Don't have a live demo because the project needs a server to deploy L1</span></p>
                </div>
            </div>
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                <div className='relative flex items-center justify-center'>
