...
import { SiSolidity, SiMongodb, SiIpfs, SiCsharp, SiReact, SiParitysubstrate, SiNodedotjs, SiTailwindcss, SiRust } from 'react-icons/si'
        ...
        <>
            ...
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <p className='text-black dark:text-white mt-1'>Demo: <a href="" target='_blank' className='text-red-500 font-semibold'>Youtube</a> | <a href="">Live demo</a> <span className='text-[12px] italic text-yellow-600 dark:text-yellow-300'>(Require metamask wallet and ETH goerli testnet)</span></p>
                </div>
            </div>
            <div className='group grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                <div className='relative flex items-center justify-center'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <div className='flex mt-1 flex-wrap'>
                        ...
                        <span className='bg-gray-200 text-black py-1 px-2 rounded-lg text-sm flex items-center w-fit mr-2'>Rust <SiRust className='ml-1' /></span>
            ...
            <div className='grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr]  p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <div className='flex mt-1 flex-wrap'>
                        <span className='bg-[#00ed64] text-black py-1 px-2 rounded-lg text-sm flex items-center w-fit mr-2'>NodeJS <SiNodedotjs className='ml-1' /></span>
                        <span className='bg-[#00ed64] text-black py-1 px-2 rounded-lg text-sm flex items-center w-fit'>MongoDB <SiMongodb className='ml-1' /></span>
                    </div>
                    <p className='my-5 text-slate-900 dark:text-[rgb(166,166,166)] tracking-wide'>Full-featured e-commerce API that supports registration and login, authentication, management, and the purchase and sale of goods.</p>
                    ...
                    <p className='text-black dark:text-white mt-1'>Demo: API Documentation</p>
                </div>
            </div>
            <div className='grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr] p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100 mb-10'>
                <div className='flex items-center justify-center'>
            ...
            <div className='grid xl:grid-cols-[0.5fr_1fr] lg:grid-cols-[1fr_2fr] p-3 shadow-5 dark:shadow-none dark:border-2 dark:border-dashed dark:border-gray-800 rounded-lg text-white dark:hover:border-gray-50 transition-all duration-100'>
                ...
                <div className='p-2 pl-5 max-[426px]:pl-2'>
                    ...
                    <div className='flex mt-1 flex-wrap'>
                        <span className='bg-white text-black py-1 px-2 rounded-lg text-sm flex items-center w-fit mr-2'>NextJS <TbBrandNextjs className='ml-1' /></span>
                        <span className='bg-blue-400 text-black py-1 px-2 rounded-lg text-sm flex items-center w-fit mr-2'>TailwindCss <SiTailwindcss className='ml-1' /></span>
                    </div>
